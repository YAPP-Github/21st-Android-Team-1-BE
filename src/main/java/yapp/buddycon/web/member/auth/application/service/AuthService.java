...
import yapp.buddycon.web.member.auth.application.port.out.AuthToMemberCommandPort;
import yapp.buddycon.web.member.auth.application.port.out.AuthToMemberQueryPort;
...
import yapp.buddycon.web.member.auth.application.port.in.AuthUseCase;
